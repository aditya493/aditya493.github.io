      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center px-4">
        <div className="md:col-span-7">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <a href="#pillars" className="w-full sm:w-auto inline-block text-center px-5 py-3 rounded-lg bg-emerald-500 text-black font-semibold hover:scale-[1.01] transition">Explore My Journey</a>
